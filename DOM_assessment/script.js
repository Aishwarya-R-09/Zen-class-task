...
head.innerHTML="Pagination in DOM Manipulation";
content.append(head);
...
col1.setAttribute("style","border: 2px solid white; padding-top:12px; padding-bottom:12px; text-align:center; background-color:coral; color:white");

let col2 = document.createElement("th");
col2.setAttribute("style","border: 2px solid white; padding-top:12px; padding-bottom:12px; text-align:center; background-color:coral; color:white");

let col3 = document.createElement("th");
col3.setAttribute("style","border: 2px solid white; padding-top:12px; padding-bottom:12px; text-align:center; background-color:coral; color:white");
...
request.onload = ()=>{
    ...
    button.addEventListener("click",function(){
        ...
        document.getElementById("btn"+(curr_page-1)).setAttribute("style","padding: 7px; background-color: coral; color:white; font-size:15px");
        curr_page-=1;
    ...
    for(let i=1;i<=10;i++){
        ...
        button.addEventListener("click",function(){
            document.getElementById("btn"+curr_page).setAttribute("style","padding: 7px; background-color: #ddd; font-size:15px");
            this.setAttribute("style","padding: 7px; background-color: coral; color:white; font-size:15px");
            curr_page = i;
    ...
    nextPage(0,10);
    document.getElementById("btn1").setAttribute("style","padding: 7px; background-color: coral; color:white; font-size:15px");
